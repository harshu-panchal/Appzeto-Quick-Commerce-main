    ...
    return (
        <div className="fixed inset-0 bg-white flex flex-col z-[999] overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            <div className="h-10 w-10 bg-primary rounded-full flex items-center justify-center text-white font-black text-sm shadow-sm ring-2 ring-white">
                                AS
                            </div>
            ...
            <div className="bg-white p-3 border-t border-slate-100 shrink-0 z-30 safe-area-bottom relative mb-4">
                ...
                <div className="flex items-end gap-2 bg-slate-50 p-2 rounded-[1.5rem] border border-slate-200 focus-within:border-brand-300 focus-within:shadow-[0_0_0_4px_rgba(97,218,251,0.1)] transition-all">
                    <button
                        onClick={() => setShowEmojiPicker(!showEmojiPicker)}
                        className={`p-2.5 rounded-full hover:text-slate-600 hover:bg-slate-200 transition-colors flex-shrink-0 ${showEmojiPicker ? 'text-primary bg-brand-50' : 'text-slate-400'}`}
                    >
                        <Smile size={22} />
                    </button>
